...
const Main = ({
  ...
  const [dataUsageDetails, setDataUsageDetails] = React.useState("")
          ...
          <Text
            onClick={() => {
              ...
              setAllValues({
                ...
                type: props.row.values.appType,
                newType: props.row.values.appType,
                usageDetails: props.row.values.dataUsageDetails
              });
              
              setDataUsageDetails(props.row.values.dataUsageDetails)
              console.log("test - ", props.row.values.dataSource)
              let x = []
  ...
  const addApiSource = text => {
    const newSourceData = [...apiData.data, { text }];
    setApiData({
      data: newSourceData,
